...
public class MessageProperties {
    ...
    public static final String CREATE_CMD_CREATED = "create.add-new-parkour";
    public static final String DELETE_CMD_ARGS = "delete.args";
    public static final String DELETE_CMD_REMOVED = "delete.delete-succes";
    public static final String CHECKPOINT_CMD_ARGS = "checkpoint.args";
    public static final String CHECKPOINT_CMD_CREATED = "checkpoint.added-checkpoint";
